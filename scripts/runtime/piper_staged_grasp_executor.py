...
# 2026-07-24: a charger (18.1mm) crushed to the commanded close width at
# -0.18N yet was verified nonempty under the old 0.08N floor -- the fingers had
# closed BELOW the object with nothing between them.  Contact evidence
# therefore rests primarily on the stall gap (a held object blocks the aperture
# well above the commanded target); the force floor is raised above that
