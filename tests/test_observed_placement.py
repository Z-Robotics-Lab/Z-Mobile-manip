...
def test_footprint_support_fraction_is_one_on_a_dense_plane_and_falls_off_an_edge():
    ...
    # The grid is hoisted out of the candidate loop in the planner, so it is
    # built here the same way: half-extents of 0.04 x 0.03, margin-grown.
    footprint_grid = planner._footprint_grid(np.array([0.08, 0.06, 0.10]))
