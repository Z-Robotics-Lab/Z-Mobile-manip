...
| VLM 消歧 | **OpenRouter `qwen/qwen3-vl-235b-a22b-instruct`** | `qwen/qwen3.5-35b-a3b` | 两者通过货架几何门槛；现场调用中 235B 延迟/成功率更稳定，32B 不进入生产回退链 | `docs/evidence/vlm_benchmark_2026-07-10.md` | ✅已批 |
